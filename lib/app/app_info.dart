...
class AppInfo {
  ...
  static const highlights = <String>[
    ...
    '小说背景:导入本地图片(裁剪 / 平铺 / 填充)· 纸张纹理强度 · 页面亮度 —— 原生渲染器上生效',
    '小说状态层:章节名 / 页码 / 全书进度 / 时间 / 真实电量可分别开关',
    '小说全文搜索:命中直达该页并高亮 · 长按选词 / 复制 / 划线笔记,划线在正文里看得见',
    ...
    '番剧分片预读:缓冲起来后往前铺,暂停也接着缓 · 换集清掉上一集,退出保留',
